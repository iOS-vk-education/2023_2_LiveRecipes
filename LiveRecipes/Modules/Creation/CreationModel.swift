    ...
    func showRecipesInDB() {
        ...
        RecipeDataManager.shared.fetch { dishes in
            ...
            for dish in dishes {
                ...
                print("nutritionValueCal: \(dish.nutritionValue.0)")
                print("nutritionValueProt: \(dish.nutritionValue.1)")
                print("nutritionValueFats: \(dish.nutritionValue.2)")
                print("nutritionValueCarb: \(dish.nutritionValue.3)")
                print("---")
